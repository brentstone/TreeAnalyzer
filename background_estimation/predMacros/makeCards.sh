#!/bin/bash
# . /Users/brentstone/Dropbox/Physics/GitRepos/TreeAnalyzer/background_estimation/predMacros/makeCards.sh baseline 0 0 0
...
macroLoc="/Users/brentstone/Dropbox/Physics/GitRepos/TreeAnalyzer/background_estimation/predMacros/"
