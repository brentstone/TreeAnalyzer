...
/*
    ...
    histResDownRe->SetXTitle("#it{m}_{bb} [GeV]");
    histResDownRe->SetYTitle("#it{m}_{HH} [GeV]");
    histResUpRe->SetXTitle("#it{m}_{bb} [GeV]");
    histResUpRe->SetYTitle("#it{m}_{HH} [GeV]");
    histScaleUpRe->SetXTitle("#it{m}_{bb} [GeV]");
    histScaleUpRe->SetYTitle("#it{m}_{HH} [GeV]");
